...
import type { Domain as _Domain } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async contactSeller(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.contactSeller(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getDomainById(arg0: bigint): Promise<Domain | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDomainById(arg0);
    ...
    async initStore(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initStore();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitOffer(arg0: bigint, arg1: number, arg2: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.submitOffer(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Domain]): Domain | null {
